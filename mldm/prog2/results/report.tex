...
data set shown in Table \ref{table:correlation}. These results are plotted against
...
there does not seem to be any obvious realtionship between accuracy
and \textit{Total Correlation}. This phenomenon can could be acounted
